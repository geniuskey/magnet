    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 space-y-4">
          {/* 회의 제목 */}
          <div>
            <h3 className="text-xl font-bold text-gray-900">{reservation.title}</h3>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-900 font-medium">{reservation.startTime} - {reservation.endTime}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-900 font-medium">{reservation.organizer}</span>
              </div>
              {reservation.participants && reservation.participants.length > 0 && (
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-gray-900 font-medium">{reservation.participants.join(', ')}</span>
                </div>
              )}
            </div>
          </div>
